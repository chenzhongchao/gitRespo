...
public class MemberProfileResult implements Serializable {
	...
	@JsonProperty("not_comment_count")
	private Integer notCommentCount;
	
	@JsonProperty("not_pay_count")
	...
	public Integer getNotCommentCount() {
		return notCommentCount;
	}
	public void setNotCommentCount(Integer notCommentCount) {
		this.notCommentCount = notCommentCount;
	}
